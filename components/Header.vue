<template>
  <header class="bg-gray-800 text-white shadow-md">
      ...
      <div class="flex items-center justify-between h-16">
        ...
        <div class="hidden lg:block">
          <div class="ml-10 flex items-baseline space-x-4">
            <a href="/" class="text-gray-300 hover:text-white px-3 py-2 rounded-md text-lg">Home</a>
            ...
            <a href="https://blog.maunguli.com/"
              class="text-gray-300 hover:text-white px-3 py-2 rounded-md text-lg">Blog</a>
          </div>
        </div>
      </div>
    </nav>
    ...
    <!-- Mobile Menu -->
    <div v-if="isMenuOpen" class="lg:hidden absolute inset-x-0 top-16 bg-gray-800 text-white shadow-lg">
